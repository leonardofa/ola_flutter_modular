...
// in ola_flutter_modular/test/lib/modules/detalhe/detalhe_page_test.dart.
...
import 'package:ola_flutter_modular/core/models/todo.model.dart' as _i3;
import 'package:ola_flutter_modular/core/stores/todo.store.dart' as _i4;
...
class MockTodoStore extends _i1.Mock implements _i4.TodoStore {
  ...
  @override
  _i3.Todo findById(String? id) => (super.noSuchMethod(
        Invocation.method(
          #findById,
          [id],
        ),
